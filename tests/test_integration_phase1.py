...
class TestIntegrationPhase1(unittest.TestCase):
    ...
    def test_04_view_switch_consistency(self):
        ...
        self.assertEqual(business_data['title'], technical_data['title'], "标题应该一致")
        self.assertEqual(business_data['case_no'], technical_data['case_no'], "case_no应该一致")
    ...
    def test_07_import_from_excel(self):
        ...
        try:
            ...
            self.assertEqual(len(case.test_steps), 2, "应该有2个步骤")
    ...
    def test_10_locator_coverage_api(self):
        ...
        self.assertEqual(data['total_steps'], 3, "总步骤数应该为3")
