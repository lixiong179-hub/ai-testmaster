...
|----------|----------|----------|----------|----------|
| `/api/v1/test-case/ai-enhanced-generate` | POST | 新增参数 | 新增 `mode`（string, 默认 'linear'）、`flow_sort_data`（object, 可选） | 前端调用需适配 |
...
**接口：** `POST /api/v1/test-case/ai-enhanced-generate`
