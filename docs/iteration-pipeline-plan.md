...
| 里程碑 | 主题 | 预计 | 任务数 | 进度 |
|:-:|---|:-:|:-:|:--:|
| M0 | 基线测量（现有用例质量/成本数据采集） | 1 周 | 3 | ✅ 3/3 |
| M1 | 基础骨架（数据模型、状态机、Pipeline 抽象、AI Client、权限、配置、审计日志） | 3-4 周 | 18 | ✅ 18/18 |
| M2 | 双向扫描 + 评审交互（旧项目场景 4，含确认门槛） | 3-4 周 | 14 | ✅ 14/14 |
| M3 | 反推 + 信号补全（场景 3、5） | 2-3 周 | 8 | ✅ 8/8 |
| M4 | 质量与运营（评分、血缘、监控、用户手册、运维） | 2-3 周 | 11 | 🔄 4/11 |
