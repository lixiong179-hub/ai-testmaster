"""Prompt 注册中心 - 同步方法 Mixin。

封装 PromptTemplate 的同步版本管理逻辑（基于 Session.query），
供 PromptRegistry 通过多继承组合使用。
...
class _PromptRegistrySyncMixin:
    """PromptRegistry 同步能力 Mixin，依赖宿主类提供 self._db (Session)。"""
