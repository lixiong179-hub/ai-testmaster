...
async def create_test_point_item(
    ...
    created_point = create_test_point(
        db=db,
    ...
    return TestPointResponse(
        id=created_point.id,
        project_id=created_point.project_id,
        requirement_id=created_point.requirement_id,
        module=created_point.module,
        point=created_point.point,
        priority=created_point.priority,
        ai_prompt=created_point.ai_prompt,
        capability_id=created_point.capability_id, version=created_point.version, status=created_point.status,
        create_time=created_point.create_time,
        created_by=created_point.created_by,
        test_case_count=0,
    )
...
async def get_related_test_cases(
    ...
    return {
        ...
        "data": {
            "total": total,
            "items": [TestPointRelatedCaseResponse.model_validate(item) for item in items],
        },
    }
