    ...
    <div class="step-content">
      ...
      <div v-if="currentStep === 2" class="result-area">
        <div v-if="importResult.success" class="result-success">
          ...
          >
            <template #title
              >AI增强解析超时，已自动降级为普通解析模式导入。如需使用AI增强，请稍后重试或检查网络连接。</template
            >
          </el-alert>
    ...
    <template #footer>
      <div class="dialog-footer">
        ...
        <el-button
          ...
          >预览</el-button
        >
        <el-button v-if="currentStep === 1" type="primary" :loading="loading" @click="doImport"
          >确认导入</el-button
        >
...
function doImport() {
  mgmt.handleImport(() => emit('imported'))
}
