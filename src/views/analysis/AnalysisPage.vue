<template>
  <div class="analysis-page">
    <el-card>
      ...
      <!-- 分析结果 -->
      <div class="analysis-result" v-if="analysisStore.status === 'success' && analysisStore.testPoints.length > 0">
        <div class="result-header">
          <h3>测试点列表</h3>
          <div class="filter-container">
            <el-select v-model="filter.module" placeholder="按模块筛选" style="width: 150px; margin-right: 10px;">
              <el-option 
        ...
        <el-collapse>
          ...
          >
            <el-table :data="modulePoints" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <div class="generate-button-container">
          ...
          <el-button type="warning" @click="generateSelectedCases" :disabled="selectedPoints.length === 0">
