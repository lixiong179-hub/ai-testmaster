<template>
  <div>
    ...
    <el-card v-if="store.generating" class="progress-card">
      <template #header
        ><div class="card-header"><span>生成进度</span></div></template
      >
      <div class="progress-container">
        ...
        <el-button type="danger" @click="store.handleCancel" v-if="store.generating"
          ><el-icon><Close /></el-icon>取消生成</el-button
        >
      </div>
    </el-card>
    ...
    <el-card v-if="store.errorMessage" class="error-card">
      <template #header
        ><div class="card-header"><span>生成失败</span></div></template
      >
      <div class="error-content">
        ...
        <el-button type="primary" @click="handleRetry" style="margin-top: 15px"
          ><el-icon><Refresh /></el-icon>重试</el-button
        >
      </div>
    </el-card>
    <FlowIssueDialog
