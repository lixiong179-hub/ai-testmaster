    ...
    <div class="test-point-selector" :class="{ 'has-data': store.testPointTotal > 0 }">
      ...
      >
        <div class="tp-toolbar-left">
          ...
          <el-tag
            ...
            >已选 {{ store.formData.test_point_ids.length }}</el-tag
          >
        </div>
        ...
        <template #header>
          <div class="tp-d-header" @mousedown.prevent>
            <div class="tp-d-search">
              <el-icon><Search /></el-icon><input placeholder="搜索..." />
            </div>
            <div class="tp-d-info">
              <span
                >{{ store.testPointPage }}/{{
            ...
            <div class="tp-content">
              <div class="tp-row1">
                ...
                <el-tag
                  ...
                  round
                  class="tp-pri"
                  >{{ store.getPriorityLabel(point.priority) }}</el-tag
                >
              </div>
      ...
      <div v-if="relatedTestPointIds.length > 0" class="tp-recommend">
        <div class="tp-recommend-header">
          <el-icon><Connection /></el-icon><span>推荐测试点（基于选中页面路径）</span>
        </div>
