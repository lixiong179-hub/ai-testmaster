    ...
    <el-card class="filter-card">
      <el-form :inline="true" :model="ctx.resourceList.filterForm">
        <el-form-item label="项目">
          <el-select
            v-model="ctx.resourceList.filterForm.project_id"
            placeholder="请先选择项目"
            style="width: 200px"
            clearable
            filterable
        ...
        <el-form-item label="类型">
          <el-select
            v-model="ctx.resourceList.filterForm.resource_type"
            placeholder="全部"
            style="width: 150px"
            clearable
            @change="ctx.resourceList.handleSearch"
          >
            <el-option
