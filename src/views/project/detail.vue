      ...
      <div v-if="projectStore.currentProject" class="project-info">
        ...
        <div class="quick-actions-section">
          ...
          <div class="quick-actions-grid">
            <el-button type="primary" plain @click="goToResources">
              <el-icon><Message /></el-icon>资源中心
            </el-button>
            <el-button type="success" plain @click="goToTestPoints">
              <el-icon><Check /></el-icon>测试点管理
            </el-button>
            <el-button type="warning" plain @click="goToCaseList">
              <el-icon><Document /></el-icon>用例列表
            </el-button>
            <el-button type="info" plain @click="goToTaskList">
              <el-icon><Timer /></el-icon>任务列表
            </el-button>
            <el-button plain @click="goToReports">
              <el-icon><DataAnalysis /></el-icon>测试报告
            </el-button>
          </div>
        </div>
        ...
        <div v-else class="device-config-section">
          ...
          <el-alert type="info" :closable="false" show-icon
            >C端测试功能正在开发中，设备配置功能暂不可用。</el-alert
          >
          <el-form
            :model="deviceForm"
            label-width="120px"
...
import { Message, Check, Document, Timer, DataAnalysis } from '@element-plus/icons-vue'
