    ...
    <el-card>
      ...
      <div v-if="projectStore.currentProject" class="project-info">
          ...
          <el-form :model="webEnvForm" label-width="100px">
            ...
            <el-form-item label="测试环境">
              <el-row :gutter="12">
                ...
                <el-col :span="5">
                  <el-input v-model="webEnvForm.test.password" type="password" placeholder="密码" show-password clearable />
                </el-col>
              </el-row>
            </el-form-item>
            <!-- 灰度环境 -->
            <el-form-item label="灰度环境">
              <el-row :gutter="12">
                ...
                <el-col :span="5">
                  <el-input v-model="webEnvForm.staging.password" type="password" placeholder="密码" show-password clearable />
                </el-col>
              </el-row>
            </el-form-item>
            <!-- 正式环境 -->
            <el-form-item label="正式环境">
              <el-row :gutter="12">
                ...
                <el-col :span="5">
                  <el-input v-model="webEnvForm.prod.password" type="password" placeholder="密码" show-password clearable />
                </el-col>
              </el-row>
            </el-form-item>
            <el-form-item>
        ...
        <div v-else class="device-config-section">
          ...
          <el-form :model="deviceForm" label-width="120px" style="margin-top: 20px; max-width: 600px;">
            ...
            <el-form-item label="App包名">
              <el-input v-model="deviceForm.app_package" placeholder="App包名，如：com.example.app" clearable />
            </el-form-item>
            <el-form-item label="Appium地址">
              <el-input v-model="deviceForm.appium_url" placeholder="http://localhost:4723" clearable />
            </el-form-item>
            <el-form-item>
        ...
        <div class="file-upload-section">
          ...
          <el-button type="primary" @click="uploadFiles" :disabled="fileList.length === 0" style="margin-top: 10px;">开始上传</el-button>
        </div>
          ...
          >
            ...
            <el-table-column prop="file_name" label="文件名称">
              <template #default="scope">
                <el-link :href="scope.row.file_url" target="_blank">{{ scope.row.file_name }}</el-link>
              </template>
            </el-table-column>
            ...
            <el-table-column label="操作" width="100" fixed="right">
              <template #default="scope">
                <el-button size="small" type="danger" @click="confirmDeleteFile(scope.row.id)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
